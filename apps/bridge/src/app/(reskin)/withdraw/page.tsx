              ...
              >
                <div className="flex items-center justify-between gap-3">
                  <input
                    ...
                    "
                  />
                  <div className="flex-shrink-0 flex items-center gap-2 bg-stacks-100 dark:bg-stacks-700 py-2 px-4 rounded-full border border-stacks-200 dark:border-stacks-600">
                    <span className="font-semibold text-stacks-700 dark:text-stacks-100">sBTC</span>
                  </div>
                </div>
              </div>
